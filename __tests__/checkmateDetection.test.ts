...
describe('Checkmate Detection', () => {
  test("should detect fool's mate (quickest possible checkmate)", () => {
    ...
    const actor = createTestActor(pieceSetups, 'white'); // White is checkmated, pass pieceSetups
  ...
  test('should detect a back-rank checkmate', () => {
    ...
    const actor = createTestActor(pieceSetups, 'white'); // Pass pieceSetups
  ...
  test('should detect a smothered checkmate', () => {
    ...
    const actor = createTestActor(pieceSetups, 'black'); // Black is checkmated, pass pieceSetups
